  ...
  <el-container style="display: flex; justify-content: center; align-items: center; height: 100vh;">
    ...
    <el-container class="background-image">
      ...
      <el-main style="display: flex; align-items: center;">
        <!--白框-->
        <div style="width:16vw; height:32vh;margin: 0 auto;background-color:white;border-radius:10px;padding:20px;">
          <!--切换账号登录-->
          <el-tabs v-model="catelog" class="demo-tabs" @tab-click="handleClick" stretch>
            <!--学生账号登录-->
            <el-tab-pane label="学生登录" name="1">
              <!--选择登录方式-->
              <div style="height:5vh">
                <el-radio-group v-model="loginway" style="align-items: center;">
                  <el-radio label="1">用户名密码登录</el-radio>
                  <el-radio label="2">手机短信登录</el-radio>
                </el-radio-group>
              </div>
              <el-form :model="loginForm" :rules="rules" ref="ruleFormRef" size="large">
                ...
                <el-form-item prop="pwd">
                  <el-input :prefix-icon="Lock" placeholder="请输入密码" v-model="loginForm.pwd" v-rules="rules.pwd"
                            show-password></el-input>
                </el-form-item>
                <el-form-item>
                  <el-button type="primary" style="width: 100%;" @click="login">登录</el-button>
                  <!-- 弹窗登录-->
                  <el-dialog :modelValue="showRoleModal" :show-close="false" :close-on-click-modal="false" title="选择角色" width="30%" style="border-radius:10px">
                    <el-radio-group v-model="selectedRoleId">
                      <el-radio
                          v-for="role in data.simpleRoleList"
                          :key="role.roleid"
                          :label="role.roleid"
                      >{{ role.rolename }}
                      </el-radio>
            ...
            <el-tab-pane label="教师登录" name="2">
              ...
              <el-form :model="loginForm" :rules="rules" ref="ruleFormRef" size="large">
                ...
                <el-form-item prop="pwd">
                  <el-input :prefix-icon="Lock" placeholder="请输入密码" v-model="loginForm.pwd" :rules="rules.pwd"
                            show-password></el-input>
                </el-form-item>
                <el-form-item>
                  <el-button type="primary" style="width: 100%;" @click="login">登录</el-button>
  ...
  proxy.$refs.ruleFormRef.validate((valid) => {
    if (valid) {
      ...
      const formData = {
        ...
        pwd: loginForm.pwd,
        catelog: loginForm.catelog,
        loginway: loginForm.loginway
      };
      ...
      if (rolesCount === 0) {
        ...
        //显示弹窗
        console.log(rolesCount, showRoleModal.value)
