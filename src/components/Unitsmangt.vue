    ...
    <div style="height: 92vh; display: flex; flex-direction: column;">
        ...
        <el-main style="padding: 0;">
            <div style="max-height: 100%; height: 100%; overflow:auto; background-color: whitesmoke;">
                <el-tree :data="treeData" draggable :props="defaultProps" node-key="id" :expand-on-click-node="false"
                    @node-drag-start="handleDragStart" @node-drag-end="handleDragEnd" @node-contextmenu="clickNode">
...
const blurInput = (node) => {
    if(node.tempData !== null && node.tempData !== node.obsname && node.tempData !== ''){
