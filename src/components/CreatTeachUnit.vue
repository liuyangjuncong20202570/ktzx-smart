<template>
    <div style="height: 92vh; display: flex; flex-direction: column;">
        <el-header
            ...
            <el-button type="danger" style="margin-left: 0.8vw;">删除</el-button>
            <el-button type="success" style="margin-left: 0.8vw;">保存</el-button>
        </el-header>

        <el-main>
            <div style="max-height: 100%; overflow:auto ; flex: auto">
                <el-tree :allow-drop="allowDrop" :allow-drag="allowDrag" :data="treeData" draggable default-expand-all
