...
const previewFile = async (file) => {
  let fileUrl = `${request.course.defaults.baseURL}/coursemangt/courseresources/download/${encodeURIComponent(file.id)}`;
...
const downloadFile = (file) => {
  ...
  let fileUrl = `${request.course.defaults.baseURL}/coursemangt/courseresources/download/${encodeURIComponent(file.id)}.${suffix}`;
  request.course({
    url: fileUrl,
    method: 'GET',
