<template>
  <el-container style="display: flex; justify-content: center; align-items: center; height: 100vh">
          ...
          >
            ...
            <el-tab-pane label="学生登录" name="1">
              ...
              <el-form :model="loginForm" :rules="rules" ref="ruleFormRef" size="large">
                ...
                <el-form-item>
                  <el-button type="primary" v-blur-on-click style="width: 100%" @click="login"
                    >登录</el-button
                  >
    ...
    <el-footer style="vertical-align: top">北京深渡观控科技有限公司 @ 2025版权所有</el-footer>
  </el-container>
</template>
<script setup>
