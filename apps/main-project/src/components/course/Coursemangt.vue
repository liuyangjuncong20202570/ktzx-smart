...
import AddCourseDialog from './subcomponents/AddCourseDialog.vue';
import EditCourseDialog from './subcomponents/EditCourseDialog.vue';
import CopyCourseDialog from './subcomponents/CopyCourseDialog.vue';
